...
class WorkflowStateTypes(str, Enum):
    DONE = "blocks"
    STARTED = "duplicates"
    UNSTARTED = "relates to"
...
class CreateStoryContents(TypedDict, total=False):                                                                                 
    ...
    deadline: Optional[datetime]                               # The due date of the story.
...
class EpicStats(TypedDict, total=False):                                                                                 
    ...
    last_story_update: Optional[datetime]                      # The date of the last update of a Story in this Epic.
...
class Epic(TypedDict, total=False):                                                                                 
    ...
    completed_at: Optional[datetime]                           # The time/date the Epic was completed.
    completed_at_override: Optional[datetime]                  # A manual override for the time/date the Epic was completed.
    created_at: Optional[datetime]                             # The time/date the Epic was created.
    deadline: Optional[datetime]                               # The Epic’s deadline.
    ...
    started_at: Optional[datetime]                             # The time/date the Epic was started.
    started_at_override: Optional[datetime]                    # A manual override for the time/date the Epic was started.
    state: str                                                 # Deprecated The workflow state that the Epic is in.
    stats: EpicStats                                           # A group of calculated values for this Epic.
    updated_at: Optional[datetime]                             # The time/date the Epic was updated.
...
class EpicState(TypedDict, total=False):                                                                                 
    ...
    type: WorkflowStateTypes                                   # The type of Epic State (Unstarted, Started, or Done)
...
class File(TypedDict, total=False):                                                                                 
    ...
    updated_at: Optional[datetime]                             # The time/date that the file was updated.
...
class Branch(TypedDict, total=False):                                                                                 
    ...
    created_at: Optional[datetime]                             # The time/date the Branch was created.
    ...
    updated_at: Optional[datetime]                             # The time/date the Branch was updated.
...
class Commit(TypedDict, total=False):                                                                                 
    ...
    updated_at: Optional[datetime]                             # The time/date the Commit was updated.
    url: str                                                   # The URL of the Commit.

class Repository(TypedDict, total=False):                                                                                 
    """Repository refers to a GitHub repository."""                                                                                 
    created_at: Optional[datetime]                             # The time/date the Repository was created.
    entity_type: str                                           # A string description of this resource.
    ...
    updated_at: Optional[datetime]                             # The time/date the Repository was updated.
...
class Milestone(TypedDict, total=False):                                                                                 
    ...
    completed_at: Optional[datetime]                           # The time/date the Milestone was completed.
    completed_at_override: Optional[datetime]                  # A manual override for the time/date the Milestone was completed.
    ...
    started_at: Optional[datetime]                             # The time/date the Milestone was started.
    started_at_override: Optional[datetime]                    # A manual override for the time/date the Milestone was started.
...
class Member(TypedDict, total=False):                                                                                 
    ...
    created_at: Optional[datetime]                             # The time/date the Member was created.
    ...
    updated_at: Optional[datetime]                             # The time/date the Member was last updated.
...
class Project(TypedDict, total=False):                                                                                 
    ...
    created_at: Optional[datetime]                             # The time/date that the Project was created.
    ...
    updated_at: Optional[datetime]                             # The time/date that the Project was last updated.
...
class CreateStoryParams(TypedDict, total=False):
    ...
    external_tickets: List[CreateExternalTicketParams]         # An array of External Tickets associated with this story. These External Tickets must have unquie external id. Duplicated External Tickets will be removed.
    file_ids: List[int]                                        # An array of IDs of files attached to the story.
    follower_ids: List[str]                                    # An array of UUIDs of the followers of this story.
    ...
    owner_ids: List[str]                                       # An array of UUIDs of the owners of this story.
    project_id: int                                            # Required. The ID of the project the story belongs to.
...
class CreateStoryLinkParams(TypedDict, total=False):
    object_id: int
    subject_id: int
    verb: StoryLinkVerb
...
class Comment(TypedDict, total=False):                                                                                 
    ...
    text: str                                                  # The text of the Comment.
    updated_at: Optional[datetime]                             # The time/date when the Comment was updated.
...
class CreateStoryCommentParams(TypedDict, total=False):                                                                                 
    ...
    created_at: datetime                                       # Defaults to the time/date the comment is created, but can be set to reflect another date.
    ...
    updated_at: datetime                                       # Defaults to the time/date the comment is last updated, but can be set to reflect another date.

class CreateTaskParams(TypedDict, total=False):                                                                                 
    """Request parameters for creating a Task on a Story."""                                                                                 
    complete: bool                                             # True/false boolean indicating whether the Task is completed. Defaults to false.
    created_at: datetime                                       # Defaults to the time/date the Task is created but can be set to reflect another creation time/date.
    description: str                                           # The Task description.
    external_id: str                                           # This field can be set to another unique ID. In the case that the Task has been imported from another tool, the ID in the other tool can be indicated here.
    owner_ids: List[str]                                       # An array of UUIDs for any members you want to add as Owners on this new Task.
    updated_at: datetime                                       # Defaults to the time/date the Task is created in Clubhouse but can be set to reflect another time/date.
...
class Label(TypedDict, total=False):                                                                                 
    ...
    created_at: Optional[datetime]                             # The time/date that the Label was created.
    ...
    updated_at: Optional[datetime]                             # The time/date that the Label was updated.
...
class Task(TypedDict, total=False):                                                                                 
    ...
    completed_at: Optional[datetime]                           # The time/date the Task was completed.
    ...
    updated_at: Optional[datetime]                             # The time/date the Task was updated.
...
class Story(TypedDict, total=False):                                                                                 
    ...
    completed_at: Optional[datetime]                           # The time/date the Story was completed.
    completed_at_override: Optional[datetime]                  # A manual override for the time/date the Story was completed.
    created_at: datetime                                       # The time/date the Story was created.
    ...
    member_mention_ids: List[str]                              # An array of Member IDs that have been mentioned in the Story description.
    mention_ids: List[str]                                     # Deprecated: use member_mention_ids.
    moved_at: Optional[datetime]                               # The time/date the Story was last changed workflow-state.
    name: str                                                  # The name of the story.
    owner_ids: List[str]                                       # An array of UUIDs of the owners of this story.
    ...
    started_at: Optional[datetime]                             # The time/date the Story was started.
    started_at_override: Optional[datetime]                    # A manual override for the time/date the Story was started.
    ...
    updated_at: Optional[datetime]                             # The time/date the Story was updated.
    workflow_state_id: int                                     # The ID of the workflow state the story is currently in.
...
class WorkflowState(TypedDict, total=False):                                                                                 
    ...
    type: WorkflowStateTypes                                   # The type of Workflow State (Unstarted, Started, or Finished)

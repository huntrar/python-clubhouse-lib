...
class ClubhouseClient:
    ...
    def createCategory(
        ...
        return self.post(
            "/categories",
            PrepareLocals(
                {"name": name, "type": type, "color": color, "external_id": external_id}
            ),
        ).json()
    ...
    def deleteCategory(self, category_public_id: int):
        ...
        """
        self.delete(
            "/categories/{category_public_id}".format(
    ...
    def listCategoryMilestones(self, category_public_id: int) -> List[Milestone]:
        ...
        """
        return self.get(
            "/categories/{category_public_id}/milestones".format(
                category_public_id=category_public_id
            )
        ).json()
    ...
    def updateCategory(
        ...
        return self.put(
            ...
            PrepareLocals({"archived": archived, "color": color, "name": name}),
        ).json()
    ...
    def createEntityTemplate(
        ...
        return self.post(
            "/entity-templates",
            PrepareLocals(
                {"name": name, "story_contents": story_contents, "author_id": author_id}
            ),
        ).json()
    ...
    def deleteEntityTemplate(self, entity_template_public_id: str):
        ...
        self.delete(
            "/entity-templates/{entity_template_public_id}".format(
                entity_template_public_id=entity_template_public_id
            )
        )
    ...
    def updateEntityTemplate(
        ...
        return self.put(
            ...
            PrepareLocals({"name": name, "story_contents": story_contents}),
        ).json()
    ...
    def createEpicComment(
        ...
        """
        return self.post(
            "/epics/{epic_public_id}/comments".format(epic_public_id=epic_public_id),
            PrepareLocals(
                {
                    "text": text,
                    "author_id": author_id,
    ...
    def createEpicCommentComment(
        ...
        """
        return self.post(
            "/epics/{epic_public_id}/comments/{comment_public_id}".format(
                comment_public_id=comment_public_id, epic_public_id=epic_public_id
            ),
            PrepareLocals(
                {
                    "text": text,
    ...
    def getEpic(self, epic_public_id: int) -> Epic:
        ...
        """
        return self.get(
            "/epics/{epic_public_id}".format(epic_public_id=epic_public_id)
        ).json()

    def getEpicComment(
        self, comment_public_id: int, epic_public_id: int
    ) -> ThreadedComment:
        """
    ...
    def updateEpicComment(
        self, comment_public_id: int, epic_public_id: int, text: str
    ) -> ThreadedComment:
        """
    ...
    def getFile(self, file_public_id: int) -> File:
        ...
        """
        return self.get(
            "/files/{file_public_id}".format(file_public_id=file_public_id)
        ).json()
    ...
    def getGroup(self, group_public_id: str) -> Group:
        ...
        return self.get(
            "/groups/{group_public_id}".format(group_public_id=group_public_id)
        ).json()
    ...
    def deleteIteration(self, iteration_public_id: int):
        ...
        self.delete(
            "/iterations/{iteration_public_id}".format(
    ...
    def getLabel(self, label_public_id: int) -> Label:
        ...
        """
        return self.get(
            "/labels/{label_public_id}".format(label_public_id=label_public_id)
        ).json()
    ...
    def listLabelEpics(self, label_public_id: int) -> List[EpicSlim]:
        ...
        """
        return self.get(
            "/labels/{label_public_id}/epics".format(label_public_id=label_public_id)
        ).json()
    ...
    def deleteLinkedFile(self, linked_file_public_id: int):
        ...
        """
        self.delete(
            "/linked-files/{linked_file_public_id}".format(
    ...
    def getMember(
        self, member_public_id: str, org_public_id: str = Omit  # type: ignore
    ) -> Member:
        """
        ...
        """
        return self.get(
            "/members/{member_public_id}".format(member_public_id=member_public_id),
    ...
    def listMembers(
        ...
        """
        return self.get(
            "/members", PrepareLocals({"org-public-id": org_public_id})
        ).json()
    ...
    def deleteMilestone(self, milestone_public_id: int):
        ...
        """
        self.delete(
            "/milestones/{milestone_public_id}".format(
    ...
    def listMilestoneEpics(self, milestone_public_id: int) -> List[EpicSlim]:
        ...
        """
        return self.get(
            "/milestones/{milestone_public_id}/epics".format(
                milestone_public_id=milestone_public_id
            )
        ).json()
    ...
    def deleteProject(self, project_public_id: int):
        ...
        """
        self.delete(
            "/projects/{project_public_id}".format(project_public_id=project_public_id)
        )
    ...
    def listStories(self, project_public_id: int) -> List[StorySlim]:
        ...
        """
        return self.get(
            "/projects/{project_public_id}/stories".format(
    ...
    def getRepository(self, repo_public_id: int) -> Repository:
        ...
        """
        return self.get(
            "/repositories/{repo_public_id}".format(repo_public_id=repo_public_id)
        ).json()
    ...
    def search(
        self, query: str, page_size: int = Omit  # type: ignore
    ) -> SearchResults:
        """
        ...
        """
        return self.get(
            "/search", PrepareLocals({"query": query, "page_size": page_size})
        ).json()
    ...
    def searchEpics(
        ...
        """
        return self.get(
            "/search/epics", PrepareLocals({"query": query, "page_size": page_size})
        ).json()
    ...
    def searchStories(
        ...
        """
        return self.get(
            "/search/stories", PrepareLocals({"query": query, "page_size": page_size})
        ).json()
    ...
    def createComment(
        ...
        """
        return self.post(
            "/stories/{story_public_id}/comments".format(
    ...
    def createMultipleStories(
        self, stories: List[CreateStoryParams]
    ) -> List[StorySlim]:
        """
        ...
        """
        return self.post("/stories/bulk", PrepareLocals({"stories": stories})).json()

    def createReaction(
        self, comment_public_id: int, emoji: str, story_public_id: int
    ) -> List[Reaction]:
        """
        ...
        """
        return self.post(
            "/stories/{story_public_id}/comments/{comment_public_id}/reactions".format(
                comment_public_id=comment_public_id, story_public_id=story_public_id
            ),
            PrepareLocals({"emoji": emoji}),
        ).json()
    ...
    def createTask(
        ...
        """
        return self.post(
            "/stories/{story_public_id}/tasks".format(story_public_id=story_public_id),
            PrepareLocals(
                {
                    "description": description,
                    "complete": complete,
    ...
    def deleteComment(self, comment_public_id: int, story_public_id: int):
        ...
        """
        self.delete(
            "/stories/{story_public_id}/comments/{comment_public_id}".format(
                comment_public_id=comment_public_id, story_public_id=story_public_id
            )
        )
    ...
    def deleteMultipleStories(self, story_ids: List[int]):
        ...
        """
        self.delete("/stories/bulk", PrepareLocals({"story_ids": story_ids}))
    ...
    def deleteStory(self, story_public_id: int):
        ...
        """
        self.delete(
            "/stories/{story_public_id}".format(story_public_id=story_public_id)
        )
    ...
    def deleteTask(self, story_public_id: int, task_public_id: int):
        ...
        """
        self.delete(
            "/stories/{story_public_id}/tasks/{task_public_id}".format(
                story_public_id=story_public_id, task_public_id=task_public_id
            )
        )
    ...
    def updateComment(
        self, comment_public_id: int, story_public_id: int, text: str
    ) -> Comment:
        """
    ...
    def createStoryLink(
        self, object_id: int, subject_id: int, verb: StoryLinkVerb
    ) -> StoryLink:
        """
        ...
        return self.post(
            "/story-links",
            PrepareLocals(
                {"object_id": object_id, "subject_id": subject_id, "verb": verb}
            ),
        ).json()
    ...
    def deleteStoryLink(self, story_link_public_id: int):
        ...
        """
        self.delete(
            "/story-links/{story_link_public_id}".format(
    ...
    def updateStoryLink(
        self, story_link_public_id: int, verb: StoryLinkVerb
    ) -> StoryLink:
        """
    ...
    def getTeam(self, team_public_id: int) -> Team:
        ...
        """
        return self.get(
            "/teams/{team_public_id}".format(team_public_id=team_public_id)
        ).json()
